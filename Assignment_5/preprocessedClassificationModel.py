"""
Title: Preprocessed vs. no additional preprocessing 
...
def train_naive_bayes_model(dataset, data_format, sign1, sign2, stop_word_list=None, df_max=1):
    ...
    vectorizer = CountVectorizer(stop_words=stop_word_list, max_df=df_max)
...
def main():
    ...
    train_naive_bayes_model(dataset='horoscopes', data_format='csv', sign1='aries', sign2="capricorn", stop_word_list=None, df_max=0.7)
