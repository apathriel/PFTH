...
def train_naive_bayes_model(dataset, data_format, sign1, sign2, stop_word_list=None, df_max=1.0, df_min=1):
...
def main():
    ...
    train_naive_bayes_model(dataset='horoscopes', data_format='csv', sign1='aries', sign2="capricorn", df_max=0.7)
